...
func (web *Web) newHandler() http.Handler {
	...
	router.HandleFunc("/panels/scoring/", web.scoringPanelHandler).Methods("GET")
	router.HandleFunc("/panels/scoring/websocket", web.scoringPanelWebsocketHandler).Methods("GET")
